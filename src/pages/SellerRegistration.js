...
const SellerRegistration = () => {
    ...
    const Register = () => {
        ...
        if (firstName === '') {
            ...
            toast.error('Enter your present age');
        } else if (phoneNumber === '') {
            ...
            axios.post('http://localhost:9090/seller/registerdetails', {
                firstName, lastName, emailId, password, username, age, gender, street, phoneNumber, address: { pincode, district, town, state, country }
            }).then((response) => {
        ...
        <div>
            ...
            <div className="containersm">
                <div className="row g-2 needs-validation">
                    ...
                    <div className="col-md-4">
                        <label htmlFor="validationCustom02" className="form-label row g-0">Age*</label>
                        <input type="number" className="form-control" id="validationCustom02" required onChange={(event) => setAge(event.target.value)} placeholder={"Age"} min={16} max={60} />
                        <div className="valid-feedback">
                            Looks good!
                        </div>
                    </div>
