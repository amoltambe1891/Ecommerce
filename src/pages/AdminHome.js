...
const AdminHome = () => {
    ...
    return ( <
        ...
        <
        h1 style = {
            { marginLeft: 445, marginBottom: 20, float: "left" } } > Welcome Administrator < /h1> <
        ...
        p className = "card-text" > Add / remove products to make available
        for sell < /p> <
        Link className = "btn btn-outline-success"
        to = "/manageProductsAdmin" > Manage Products < /Link> <
        /div> <
        /div> <
        /div> <
        div className = "col-sm-4" >
        ...
        to = "/allConsumerAdmin" > Consumers Detail < /Link> <
        /div> <
        /div> <
        /div> <
        div className = "col-sm-4" >
        ...
        to = "/allSellerAdmin" > Sellers Detail < /Link> <
        /div> <
        /div> <
        /div> <
        /div> <
        ...
        to = "/allPurchaseDetailsForAdmin" > Show Record < /Link> <
        /div> <
        /div> <
        /div> <
        div className = "col-sm-4" >
        ...
        to = "/deletedConsumerRecord" > Get Record < /Link> <
        /div> <
        /div> <
        /div> <
        div className = "col-sm-4" >
        ...
        Link className = "btn btn-outline-primary"
        to = "/deletedSellerRecord" > Get Record < /Link> <
        /div> <
        /div> <
        /div> <
        /div> <
        ...
        Link className = "btn btn-outline-warning"
        to = "/consumerQueryAdmin" > Get Queries < /Link> <
        /div> <
        /div> <
        /div> <
        div className = "col-sm-4" >
        ...
        Link className = "btn btn-outline-primary"
        to = "/sellerQueryAdmin" > Get Queries < /Link> <
        /div> <
        /div> <
        /div> <
        div className = "col-sm-4" >
        ...
        Link className = "btn btn-outline-danger"
        to = "/changeAdminPassword" > Change Password < /Link> <
        /div> <
        /div> <
        /div> <
        /div> <
